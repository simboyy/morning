(function () {
    ...
    angular.module('ngFader', [])
     ...
     .directive('ngFaderMP', function($interval) {
	  ...
	  function link(scope){
		...
		scope.imagesMP = [{
			src: 'img/fader-images/mp1.jpeg.png',
			alt: 'The Beach'
		}, {
			src: 'img/fader-images/mp2.jpeg',
			alt: 'The Beach'
		}, {
			src: 'img/fader-images/3.mp3.jpeg',
			alt: 'The Beach'
		}, {
			src: 'img/fader-images/mp4.jpeg',
			alt: 'The Beach'
		}];
	  ...
	  return {
	    ...
	    template: '<div class="ng-fader">'+
			...
			'<ul>' + 
				'<li ng-repeat="image in imagesMP" ng-click="toggleStartStop()" ng-swipe-right="sliderBack()" ng-swipe-left="sliderForward()"><img data-ng-src="{{image.src}}" data-ng-alt="{{image.alt}}" ng-class="show($index)"/></li>' + 
			'</ul>' + 
